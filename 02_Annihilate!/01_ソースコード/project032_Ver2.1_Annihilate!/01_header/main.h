...
#define TITLE_SETUP_TXT	"02_data\\00_TXT\\stage_title.txt"	// タイトルのステージセットアップ用のテキストファイルの相対パス
#define GAME_SETUP_TXT	"02_data\\00_TXT\\stage_game.txt"		// ゲームのステージセットアップ用のテキストファイルの相対パス

#define NONE_IDX	(-1)	// 使用でいないインデックス
