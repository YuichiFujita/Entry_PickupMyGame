...
//	マクロ定義
//**********************************************************************************************************************
#define MAX_VALUE		(5)			// 使用するポリゴン数 (桁の最大数)
...
const char *apTextureValue[] =		// テクスチャの相対パス
{
	...
	"02_data\\02_TEXTURE\\number001.png",	// 数字 (通常赤) のテクスチャの相対パス
	"02_data\\02_TEXTURE\\number002.png",	// 数字 (縁取り) のテクスチャの相対パス
	"02_data\\02_TEXTURE\\number003.png",	// 数字 (縁取り緑) のテクスチャの相対パス
};
