...
#define SCORE_POS_VAL_X	(1115.0f)	// スコア (値) の絶対座標 (x)
#define SCORE_POS_X		(1020.0f)	// スコア (背景) の絶対座標 (x)
#define SCORE_POS_Y		(60.0f)		// スコアの絶対座標 (y)
#define SCORE_WIDTH		(225.0f)	// スコアの横幅 / 2
...
{
	"02_data\\02_TEXTURE\\ui003.png",	// スコア背景のテクスチャ相対パス
};
