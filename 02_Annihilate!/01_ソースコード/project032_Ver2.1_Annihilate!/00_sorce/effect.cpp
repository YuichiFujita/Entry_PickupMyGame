...
{
	"02_data\\02_TEXTURE\\effect000.jpg",	// エフェクトのテクスチャの相対パス
	"02_data\\02_TEXTURE\\effect001.jpg",	// 草刈りエフェクトのテクスチャの相対パス
	"02_data\\02_TEXTURE\\effect002.jpg",	// 回復エフェクトのテクスチャの相対パス
};
...
void InitEffect(void)
{
	...
	{ // エフェクトの最大表示数分繰り返す
		...
		g_aEffect[nCntEffect].type    = EFFECTTYPE_NORMAL;	// 種類
...
//	エフェクトの設定処理
//======================================================================================================================
void SetEffect(D3DXVECTOR3 pos, D3DXVECTOR3 move, D3DXCOLOR col, EFFECTTYPE type, int nLife, float fRadius, float fSub)
{
	// ポインタを宣言
	VERTEX_3D *pVtx;	// 頂点情報へのポインタ
	...
	{ // エフェクトの最大表示数分繰り返す
		...
		{ // エフェクトが使用されていない場合
			...
			g_aEffect[nCntEffect].type    = type;		// 種類
